<x-app-layout>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div id="{{ $setting->key }}" data-theme="{{ @$options->theme }}"
                                                    ...
                                                    class="ace_editor min_height_400" name="data[{{ $setting->id }}]">{{
                                                    $setting->value ?? '' }}</div>
                                                <!-- prettier-ignore-end -->
                                                ...
                                                <div class="mt-1 mb-2">
                                                            ...
                                                            <g id="Page-1" stroke="none" stroke-width="1" fill="none"
                                                                ...
                                                                <g id="icon-55-document-text"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        id="document-text" sketch:type="MSShapeGroup">
                                                                    </path>
                                                                </g>
                                                            </g>
                                                        </svg>
                                                    ...
                                                    <a href="{{ route('admin.settings.unsetValue',$setting->id) }}">
                                                        <svg width="16px" enable-background="new 0 0 32 32" id="Слой_1"
                                                            version="1.1" viewBox="0 0 32 32" xml:space="preserve"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                                            <g id="Cancel">
                                            ...
                                            <div class="col-md-4">
                                                <div>
                                                    <select class="select2Tag form-control"
                                                        name="group[{{ $setting->id }}]" id="group[{{ $setting->id }}]">
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/theme-clouds.min.js">
    </script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/mode-json.min.js">
    </script>
