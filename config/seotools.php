...
return [
    'meta' => [
        ...
        'defaults'       => [
            ...
            'separator'    => ' - ',
            'keywords'     => [
                'iqbal', 'hasan', 'dev', 'iqbalhasandev', 'Rabiul Hassan dev', 'Rabiul Hassan', 'iqbalhasan.dev', 'iqbalhasndev', 'web', 'developer', 'open source package', 'laravel', 'laravel developer', 'web designer', 'node js developer', 'vue js developer'
            ],
